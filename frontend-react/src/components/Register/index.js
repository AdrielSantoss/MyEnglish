 ...
 return (
   <div className="register-wrapper mt-5">
      ...
      <div className="hello">
       ...
       <center>Wellcome to MyEnglish, por favor faça seu registro</center> 
       <hr></hr>
       <form onSubmit={register}>
        <div className="form-group">
            <label for="exampleInputEmail1">User name</label>
            <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onKeyUp={(e)=>{setName(e.target.value)}}/>
        </div>
            <div className="form-group">
            <label for="exampleInputEmail1">Email address</label>
            <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" onKeyUp={(e)=>{setEmail(e.target.value)}}/>
        </div>

        <div className="form-group">
          <label for="exampleInputPassword1">Password</label>
          <input type="password" className="form-control" id="exampleInputPassword1" onKeyUp={(e)=>{setPassword(e.target.value)}} />
        </div>
        <div className="form-group">
            <label for="exampleInputPassword1">Confirm Password</label>
            <input type="password" className="form-control" id="exampleInputPassword1" onKeyUp={(e)=>{setConfirmPassword(e.target.value)}}/>
        </div>
          <span className="msg">{msg}</span>
          <small id="emailHelp" class="form-text text-muted mb-3">Já possui uma conta? <Link to="/login">click aqui</Link> </small>
