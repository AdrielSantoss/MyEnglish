...
<div class="hello">
    ...
    <b-form @submit="onSubmit" @reset="onReset" >
      ...
      <b-form-group id="input-group-3" label="Repita a senha" label-for="input-3">
         <b-form-input
          id="input-2"
          type="password"
      ...
      <b-form-group id="input-group-4">
            Já possui uma conta? <router-link to="/login"> clique aqui</router-link> <br>
    ...
    methods: {
      onSubmit(evt) {
        ...
        if(this.password === this.confirmPassword){
            ...
            try {
              await UserService.register({name: this.name, email: this.email, password: this.password})
            } catch (err) {
              this.error = 'Erro: ' + err
            }
          }
