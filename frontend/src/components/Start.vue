<template>
  <div class="start" >
      <div class="start-wrapper mt-5" v-show="!showAlert">
      <div class="start-content" >
        <div class="hello">
            <span class="icon icon--circle">
                <img src="../assets/icons/configuracao.png" alt="" srcset="">
                </span>
                <h1 class="hello-title">Select your level</h1>
        </div>
        <center>Por favor, selecione seu nível de conhecimento em inglês.</center> 
        <hr>
        <div class="levels">
            <div class="basic "><div class="level-title">Básico</div></div>
            <div class="intermediario "><div class="level-title">Intermediario</div></div>
            <div class="avanced "><div class="level-title">Avançado</div></div>
            <div class="idontknow "><div class="level-title" @click="showChange">Eu não sei</div></div>
        </div>
      </div>
      </div>


      <div class="start-alert" v-show="showAlert">
        <div class="test-wrapper">
          ...
          <span class="icon icon--circle">
            ...
            <h1 class="hello-title">let's go</h1>
      </div>
       <center>Faremos um teste para sabermos seu nível de inglês, ok?</center> 
       <hr>
       <div class="buttons-response">
            <router-link to="/knowledgeTest"><b-button class="mr-2" type="submit" variant="primary">Ok, vamos.</b-button></router-link>
            <b-button type="reset" variant="dark" @click="showChange">Não, eu ja sei meu nível.</b-button>
       </div>
      </div>
      </div>
...
.idontknow {
    background-image: url('../assets/imgs/question.jpg');
    background-repeat: no-repeat;
}
.avanced {
    background-image: url('../assets/imgs/avanced.jpg');
    background-repeat: no-repeat;
  
}
.intermediario{
    background-image: url('../assets/imgs/intermediario.jpg');
    background-position: center;
    background-repeat: no-repeat;
}
.basic {
    background-image: url('../assets/imgs/basic.jpg');
